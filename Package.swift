...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.10.58"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.10.47"),
        .package(url: "https://github.com/DoubleNode/DNSCrashWorkers.git", from: "1.10.49"),
        .package(url: "https://github.com/DoubleNode/DNSError.git", from: "1.10.0"),
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.10.87"),
