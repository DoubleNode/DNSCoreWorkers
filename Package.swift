...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.10.57"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.10.47"),
        .package(url: "https://github.com/DoubleNode/DNSCrashWorkers.git", from: "1.10.48"),
        .package(url: "https://github.com/DoubleNode/DNSError.git", from: "1.10.0"),
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.10.85"),
