...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSCoreWorkers.git", from: "1.10.51")
]
```
...
-   DNSAppCore v1.10.2+
-   DNSBaseTheme v1.10.12+
-   DNSBlankWorkers v1.10.56+
-   DNSCore v1.10.47+
-   DNSCrashWorkers v1.10.47+
-   DNSError v1.10.0+
-   DNSProtocols v1.10.84+
-   Geodesy v1.2.2+
