...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSCoreWorkers.git", from: "1.10.53")
]
```
...
-   DNSAppCore v1.10.2+
-   DNSBaseTheme v1.10.14+
-   DNSBlankWorkers v1.10.57+
-   DNSCore v1.10.47+
-   DNSCrashWorkers v1.10.48+
-   DNSError v1.10.0+
-   DNSProtocols v1.10.86+
-   Geodesy v1.2.2+
