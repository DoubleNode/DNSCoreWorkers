...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSCoreWorkers.git", from: "1.10.54")
]
```
...
-   DNSAppCore v1.10.2+
-   DNSBaseTheme v1.10.15+
-   DNSBlankWorkers v1.10.58+
-   DNSCore v1.10.47+
-   DNSCrashWorkers v1.10.49+
-   DNSError v1.10.0+
-   DNSProtocols v1.10.87+
-   Geodesy v1.2.2+
